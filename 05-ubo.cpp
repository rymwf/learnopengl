...
class Hello
{
    ...
    {
        indexBuffer = createBuffer(GL_ELEMENT_ARRAY_BUFFER, static_cast<GLsizeiptr>(indices.size() * sizeof(indices[0])), indices.data(), 0);
    }
    GLuint createVAO(const std::vector<GLuint> &vertexBuffers, const VertexInputStateDescription &vertexInputDescription, GLuint indexBuffer)
    {
    ...
    void createVertexArrays()
    {
        ...
        vertexArray = createVAO({vertexBuffer}, vertexInputStateDescription, indexBuffer);
    }
