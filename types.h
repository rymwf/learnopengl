...
{
	BUFFER_MUTABLE_STORAGE_STREAM_DRAW,
...
enum DescriptorType
{
	DESCRIPTOR_TYPE_SAMPLER,				//sampler (vulkan)
	DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, //sampler2D
	DESCRIPTOR_TYPE_SAMPLED_IMAGE,			//texture2D (vulkan)
	DESCRIPTOR_TYPE_STORAGE_IMAGE,			//image2D
	DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER,	//samplerbuffer	(access to buffer texture,can only be accessed with texelFetch function) ,textureBuffer(vulkan)
	DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER,	//imagebuffer (access to buffer texture)
	DESCRIPTOR_TYPE_UNIFORM_BUFFER,			//uniform block
	DESCRIPTOR_TYPE_STORAGE_BUFFER,			//buffer block
	DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC,
	DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC,
	DESCRIPTOR_TYPE_INPUT_ATTACHMENT0,
};
...
{
	IMAGE_CREATE_MUTABLE_FORMAT_BIT = 0x1, //!< cannot use image view
	IMAGE_CREATE_RENDER_BUFFER_BIT = 0x2
};
...
enum AttachmentLoadOp
{
	...
	ATTACHMENT_LOAD_OP_CLEAR, //glClear
	ATTACHMENT_LOAD_OP_DONT_CARE,
};

enum AttachmentStoreOp
{
	ATTACHMENT_STORE_OP_STORE, //where to store
	ATTACHMENT_STORE_OP_DONT_CARE,
};

enum PipelineBindPoint
{
	PIPE_LINE_BIND_POINT_GRAPHICS,
	PIPE_LINE_BIND_POINT_COMPUTE,
};
